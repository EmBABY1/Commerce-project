...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 13, 2024 at 03:35 PM
...
(5, '2024_01_11_141515_create_mycart_table', 1),
(6, '2024_01_11_143351_create_mycart_table', 2),
(7, '2024_02_05_135431_posts', 3);
...
INSERT INTO `order` (`product_id`, `product_name`, `id`, `order_details_id`, `user_id`, `price`) VALUES
(2, 'bag2', 9, 1707750161, 1, 30),
(6, 'bag6', 10, 1707750161, 1, 30),
(7, 'ca1', 11, 1707750161, 1, 30);
...
INSERT INTO `order_details` (`name`, `email`, `address`, `phone`, `comment`, `payment_method`, `id`) VALUES
('Eslam Embaby', 'hossameslam79@gmail.com', 'Jeddah , Saudi Arabia', '+201225749792', '123', 'visa', 1707750161);
...
(1, '1', '1', '2024-02-08 12:35:47', '2024-02-08 12:35:47'),
(2, '2', '2', NULL, NULL),
(3, '3', '3', '2024-02-07 15:51:24', '2024-02-07 15:51:24'),
(4, '4', '4', '2024-02-07 16:03:12', '2024-02-07 16:03:12'),
(5, '5', '5', '2024-02-07 16:13:26', '2024-02-07 16:13:26'),
(6, '6', '6', '2024-02-08 12:13:49', '2024-02-08 12:13:49');
...
(1, 'bag1', '', 'assets/img/bags/bag1.jpg', 30, 21, 4),
(2, 'bag2', '', 'assets/img/bags/bag2.jpg', 30, 19, 4),
(3, 'bag3', '', 'assets/img/bags/bag3.jpg', 30, 29, 4),
(4, 'bag4', '', 'assets/img/bags/bag4.jpg', 30, 29, 4),
(5, 'bag5', '', 'assets/img/bags/bag5.jpg', 30, 30, 4),
(6, 'bag6', '', 'assets/img/bags/bag6.jpg', 30, 29, 4),
(7, 'ca1', '', 'assets/img/cameras/ca1.jpg', 30, 29, 6),
...
(11, 'dr1', '', 'assets/img/drinks/dr1.jpg', 30, 29, 1),
...
(33, 'f2', '', 'assets/img/food/f2.jpg', 20, 30, 2),
...
(1, 'eslam', 'hossameslam79@gmail.com', '0000-00-00 00:00:00', '$2y$12$qFpji.LIRIUB.r4VxXbVtezKyP2Sg7/EjbPuTb7IGNnpFWDFWM2pm', 'admin', NULL, '2024-01-08 10:35:32', '2024-01-08 10:35:32'),
(2, 'a', 'ABCDE@gmail.com', NULL, '$2y$12$RfIDvb3r1RjcezOQiYqZm.4B8CNpTtIbuePUMD4vsAkTjPepYRPWO', NULL, 'NANOrLXuQJds0J5kqu4B0QEKkEyV41JGR4djSc4u5Pqer5I1HvIK5OzDoCAq', '2024-01-04 17:15:48', '2024-01-04 17:15:48'),
(13, '122', '11@gmail.com1', NULL, '123', NULL, NULL, '2024-02-08 14:25:47', '2024-02-08 14:25:47'),
(14, 'Eslam Embaby', 'hossameslam79@gmail.com1', NULL, '$2y$12$kyC0nm0yOaqHXgtlKatW9OQRvqbNjfqjSa9aPHY2jQLcRTiJitch6', NULL, NULL, '2024-02-11 13:46:44', '2024-02-11 13:46:44');
...
ALTER TABLE `order`
  ...
  ADD KEY `order_details_id` (`order_details_id`,`user_id`),
...
--
ALTER TABLE `order_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1707750162;
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `order_ibfk_1` FOREIGN KEY (`order_details_id`) REFERENCES `order_details` (`id`),
